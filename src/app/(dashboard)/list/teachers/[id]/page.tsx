                ...
                <div className={'flex flex-col lg:flex-row gap-4'}>
                    <div className={'bg-skyBlue py-6 px-4 rounded-md flex-1 flex gap-4'}>
                        ...
                        <div className={'w-2/3 flex flex-col items-center gap-1'}>
                            <h3 className={'text-xl font-semibold pb-3'}>Serhii Ivashenko</h3>
                            <p className={'text-sm text-gray-500 pb-5'}>English teacher</p>
                            <div
            ...
            <div className={"w-full xl:w-1/3 flex flex-col gap-4"}>
                <div className={'bg-white p-4 rounded-md'}>
                    ...
                    <div className={'mt-4 flex gap-4 flex-wrap text-xs text-gray-500 font-semibold'}>
                        <Link href={'/'} className={'p-3 rounded-md bg-lightSkyBlue'}>Teacher's Classes</Link>
                        <Link href={'/'} className={'p-3 rounded-md bg-lightPurple'}>Teacher's Students</Link>
                        <Link href={'/'} className={'p-3 rounded-md bg-lightYellow'}>Teacher's Lessons</Link>
                        <Link href={'/'} className={'p-3 rounded-md bg-pink-50'}>Teacher's Exams</Link>
                        <Link href={'/'} className={'p-3 rounded-md bg-lightSkyBlue'}>Teacher's Assignments</Link>
                    </div>
                </div>

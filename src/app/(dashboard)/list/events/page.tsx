...
const EventsListPage = () => {
    const renderRow = (item: IEvent): React.ReactNode => {
        return <tr key={item.id} className={'border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lightPurple'}>
            ...
            <td className={'hidden md:table-cell cursor-default'}>{item.startTime}</td>
            <td className={'hidden md:table-cell cursor-default'}>{item.endTime}</td>
            <td className={''}>
